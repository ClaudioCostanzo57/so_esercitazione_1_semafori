...
int main()
{
    ...
    vett_id =shmget(shm_key,sizeof(int)*NUM_ELEMENTI,IPC_CREAT|0664);/* TBD: usare shmget() per creare un vettore di interi su 
               *      memoria condivisa, con NUM_ELEMENTI elementi */
    ...
    key_t buff_key=IPC_PRIVATE;
    buffer_id =shmget(buff_key,sizeof(int),IPC_CREAT|0664); /* TBD: usare shmget() per creare un buffer singolo su
